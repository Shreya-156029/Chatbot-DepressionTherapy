...
def predict(text):
    ...
    txt_list = [(vocab.token2id[word] + 1) for word in text
...
if (response=="What is your name?"):
   ...
   print("Shreya, vaishnavi and Poonam from WCE")	
elif(response=="How was your day?"):
   print("It was quite good..")
elif(response=="What is machine learning?"):
   print("Machine learning is the scientific study of algorithms and statistical models that computer systems use to perform a specific task without using explicit instructions, relying on patterns and inference instead. It is seen as a subset of artificial intelligence")
